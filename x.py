...
#os.system('xdg-open https://chat.whatsapp.com/BU4suCDgLamIL4fpUhTTpu')
...
\033[1;91m╚═╝╩ ╩╚═╝╝╚╝  ╩╚═╚═╝═╩╝   ╩ ╚═╝╚═╝╩═╝      
\033[1;91m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
              \033[1;32m♦️OWNER \033[1;91m EMON""")   
...
class Main:
    ...
    def __init__(self):
        ...
        os.system('espeak -a 200 "EMON RED RENDOM CREKING"')
...
def num():
    ...
    with ThreadPool(max_workers=30) as noob:
        ...
        os.system('espeak -a 200 " CREKING , START"')
        ...
        print(' \033[1;92m[+] Wait For ids v19.0 ')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\x1b[\033[1;32mRED🍬\033[1;32m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
        ...
        sys.stdout.write(f'\r\033[\0[\x1b[\033[1;34mRED🍬] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
